...
Developed live chat system to use various platform.`,
  },
  {
    ...
    responsibilities: `- Develop web applications using nextjs, react js . etc...
- Suitable for portfolio, photography, or project showcases
- Clean UI with hover effects and smooth transitions Modular structure for easy content updates
- Responsive design using CSS Grid and Flexbox Lightbox image viewer with JavaScript`,
  },
  {
    id: 3,
    company: "QHRM",
